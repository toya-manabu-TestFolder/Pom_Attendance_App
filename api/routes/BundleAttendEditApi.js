...
const BundleAttendEditRouter = express.Router();

BundleAttendEditRouter.post("/getDayAttendanceData", async (req, res) => {
  try {
...
BundleAttendEditRouter.post("/registDayAttendData", async (req, res) => {
...
BundleAttendEditRouter.post("/updateDayAttendData", async (req, res) => {
  try {
    await axios
      .get(
...
export default BundleAttendEditRouter;
