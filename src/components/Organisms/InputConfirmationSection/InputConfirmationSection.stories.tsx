...
import InputConfirmationSection from "./InputConfirmationSection";
import { Provider } from "react-redux";
import { store } from "../../../app/store";
import { BrowserRouter } from "react-router-dom";

const meta = {
  title: "Organisms/InputConfirmationSection",
  component: InputConfirmationSection,
  tags: ["autodocs"],
  parameters: {
    backgrounds: {
...
} satisfies Meta<typeof InputConfirmationSection>;

export default meta;

type Story = StoryObj<typeof InputConfirmationSection>;
